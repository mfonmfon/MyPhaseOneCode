		...
		int purchased = scan.nextInt();
			...
			int discount = scan.nextInt();
				...
				int total = 0;
					...
					for(int counter = 1; counter <= purchased; counter++){

					System.out.println("Please Enter cost for item " + (counter + 0));
					...
					double discountPercentage =  discountAmount - discountAmount;
